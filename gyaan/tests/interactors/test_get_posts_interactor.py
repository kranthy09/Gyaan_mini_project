...
class TestGetPostInteractor:
    ...
    def test_get_posts_interactor(self, post_storage, post_presenter):
        ...
        answer_dtos = [
            AnswerDto(
                answer_id=5,
                answer_content="This is answer 1",
                answered_at="02-08-2020",
                answered_by_id=7,
                approved_by_id=1
            ),
            AnswerDto(
                answer_id=6,
                answer_content="This is answer 2",
                answered_at="02-08-2020",
                answered_by_id=8,
                approved_by_id=2
            )
        ...
        post_storage.get_answer_dtos \
            .return_value = answer_dtos
        post_storage.get_post_user_ids_dto \
            .return_value = post_user_id_dtos
        ...
        post_storage.get_post_answer_ids_dtos \
            .assert_called_once_with(post_ids=post_ids)
        post_storage.get_answer_dtos \
            .assert_called_once_with(answer_ids=answer_ids)
        post_storage.get_post_user_ids_dto \
            .assert_called_once_with(post_ids=post_ids)