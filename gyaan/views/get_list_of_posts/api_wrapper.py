...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from gyaan.views.get_list_of_posts.request_response_mocks \
    ...
    test_case = {
        "path_params": {},
        "query_params": {'offset': 551, 'limit': 312},
        "header_params": {},
        "body": body,
    ...
    response_tuple = mock_response(
        app_name="gyaan", test_case=test_case,
        operation_name="get_list_of_posts",
